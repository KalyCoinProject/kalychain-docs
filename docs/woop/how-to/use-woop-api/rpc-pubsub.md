---
description: Using RPC Pub/Sub with KalyChain WebSockets
tags:
  - private networks
---
...
!!!important
    ...
    Unlike other [KalyChain API methods](../../reference/api/index.md), you cannot call
...
If a chain reorganization occurs, Kaly resubmits transactions for inclusion in the new canonical
