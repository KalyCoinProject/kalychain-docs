---
description: Starting KalyChain
---


## Prerequisites

[Kaly installed](install/binary-distribution.md)
...
`kaly/build/distribution/kaly-<version>` directory.
...
When you specify [`--network=dev`](../reference/cli/options.md#network), KalyChain uses the
